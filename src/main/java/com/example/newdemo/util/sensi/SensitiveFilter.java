package com.example.newdemo.util.sensi;
...
//org.springframework.util.ClassUtils.class.getClassLoader().getResourceAsStream(filePath)
			...
			org.springframework.util.ClassUtils.class.getClassLoader().getResourceAsStream("sensi_words.txt")
...
//	}
	 ...
	 */
	public SensitiveFilter(BufferedReader reader){//BufferedReader reader
//		BufferedReader reader ;
		try{


//			new InputStreamReader(new FileInputStream(ResourceUtils.getFile("classpath:sensi_words.txt")), StandardCharsets.UTF_8);
//			reader =new BufferedReader(new InputStreamReader(new FileInputStream(ResourceUtils.getFile("classpath:sensi_words.txt")), StandardCharsets.UTF_8));
