...
public class SensitiveWordUtil {
     ...
     *
     */
    public  void init() {//synchronized   Set<String> sensitiveWordSet        * @param sensitiveWordSet 敏感词库

        Set<String> sensitiveWordSet = new HashSet<>();
        sensitiveWordSet.add("操");
        sensitiveWordSet.add("日");
//        sensitiveWordSet.add("草你");
        sensitiveWordSet.add("你妈");
        sensitiveWordSet.add("中国");
        sensitiveWordSet.add("共产党");
        sensitiveWordSet.add("逼");
//        sensitiveWordSet.add("你妈逼");
//        sensitiveWordSet.add("我日");
//        sensitiveWordSet.add("我操");
        sensitiveWordSet.add("草");
//        sensitiveWordSet.add("我草");
        sensitiveWordSet.add("主人");
    ...
    public  String replaceSensitiveWord(String txt, char replaceChar) {
        return replaceSensitiveWord(txt, replaceChar, MinMatchTYpe);//最小匹配规则
    }
...
////        return replaceSensitiveWord(txt, replaceStr, MinMatchTYpe);
////    }
